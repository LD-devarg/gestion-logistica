...
<body>
  ...
  <div class="doc-header">
    <div class="empresa-info">
      <img class="empresa-logo" src="/favicon.svg" alt="${EMPRESA}" />
...
export async function savePreliquidacionToDrive(preliq) {
  if (!preliq.carpeta_drive_id) {
    return { ok: false, error: 'La preliquidacion no tiene carpeta demo configurada.' }
  }
...
export async function saveLiquidacionToDrive(liq) {
  if (!liq.carpeta_drive_id) {
    return { ok: false, error: 'La liquidacion no tiene carpeta demo configurada.' }
  }
